...
INSERT INTO `customer` (`id`, `country_id`, `tax_rate`, `name`, `firm`, `address`, `company_email`, `chief_email`, `company_phone`, `chief_phone`, `site_company`, `description`, `is_company`) VALUES (143,245,1.00,'Анна Альфа-плюс','Алфа плюс','Киев','252342@gmail.com','252342@gmail.com','','0660443958','',NULL,0),(144,245,2.00,'Роман','-','Харьков, Сумская 51','','send1message1@gmail.com','','0508899654','',NULL,0),(145,245,NULL,'Алина (Магнит)','Магнит','Харьков ','','','','05765165615','',NULL,1),(146,245,NULL,'Кирилл Владимирович (Эксперт солюшнс)','Expert solutions','Киев','','','','','',NULL,0);
...
INSERT INTO `test` (`id`, `result`, `test_type_id`, `customer_id`) VALUES
(32,'Димасс,  да,  1,  ,   Часть вопроса3 ,  Радио',NULL,NULL),
(33,'Димасс,  refr,  1,  ,   Часть вопроса3 ,  Радио',NULL,NULL),
(34,'fevfev,  refre,  1,  ,  Часть вопроса1 ,  Радио',149,NULL),
(35,'Дима,    Как дела,    1,    ,     Часть вопроса3 ,    Радио',149,NULL),
(36,',    1525256,    1,    ,     Часть вопроса3 ',149,NULL);
...
INSERT INTO `test_type` (`id`, `name`, `link`, `user_id`) VALUES
(139,'Тест на программиста  ','test/test/test?id=139',NULL),
(140,'Новый тест','test/test/test?id=140',NULL),
(141,'wdwdw','test/test/test?id=141',NULL),
(142,'Тест для менеджера ','test/test/test?id=142',NULL),
(143,'Тест на джуна','test/test/test?id=143',NULL),
(144,'тест','test/test/test?id=144',NULL),
(145,'Тест на джуна2','test/test/test?id=145',NULL),
(146,'Тест Клиента','test/test/test?id=146',NULL),
(147,'wdwdw','test/test/test?id=147',NULL),
(148,'Тестовый тест','test/test/test?id=148',NULL),
(149,'Новый тест','test/test/test?id=149',NULL),
(151,'Тест на Junior PHP','test/test/test?id=151',NULL);
...
-- Dump completed on 2021-02-02 13:29:15
