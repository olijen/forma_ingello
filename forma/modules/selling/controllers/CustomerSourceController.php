...
use forma\modules\selling\records\customersource\CustomerSourceSearch;
use forma\components\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * CustomerSourceController implements the CRUD actions for CustomerSource model.
 */
class CustomerSourceController extends Controller
{
    ...
    {
        $searchModel = new CustomerSourceSearch();
    ...
    /**
     * Displays a single CustomerSource model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new CustomerSource model.
    ...
    /**
     * Updates an existing CustomerSource model.
