...
use forma\modules\selling\records\selling\StateInitial;
use keygenqt\autocompleteAjax\AutocompleteAjax;
use forma\modules\selling\records\sellingproduct\SellingProduct;
use yii\helpers\Html;

/** @var SellingProduct $nomenclature */
...
<?php if ($nomenclature->selling->stateIs(new StateInitial())) : ?>
    ...
    <div class="nomenclature-position">
        ...
        <?php $form = ActiveForm::begin([
            'action' => '/selling/adding-form/add-position?sellingId=' . $nomenclature->selling_id,
            'validationUrl' => ['/selling/adding-form/validate', 'sellingId' => $nomenclature->selling_id],
...
$(function() {
    var ProductAutocomplete = (function() {
        ...
        var productIdInput = $('input[name="SellingProduct[product_id]"]');
        var productId = null;
        var originalId = null;
...
$(function() {
    var productInput = $('input[name="SellingProduct[product_id]"]'),
        ...
        function getProductCost(event) {
            if (productInput.val() && costTypeSelect.val()) {
                $.ajax({
                    url: '/selling/nomenclature/get-product-cost',
                    data: {
