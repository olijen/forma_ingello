...
use forma\modules\hr\records\selling\Selling;
use yii\widgets\Pjax;
use kartik\form\ActiveForm;
use yii\helpers\Html;
use forma\modules\worker\records\Worker;
use forma\modules\warehouse\records\Warehouse;
use forma\modules\hr\records\selling\StateConfirm;
use yii\helpers\Url;
...
$js = "
    $('document').ready(function() {
        $('#selling-form-pjax').on('pjax:complete', function(xhr, textStatus, error, options) {
            ...
            krajeeDialog.alert('Данные сохранены');
        });
    });
";
$this->registerJs($js);
...
<div class="operation-form">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            ])->dropDownList(Worker::getList(), ['prompt' => '']) ?>
        </div>
    </div>
