  ...
  <div class="login-box">
      <div class="login-logo">
        ...
        <h4 style="color: white;">Веб сервис для автоматизации и мониторинга бизнеса</h4>
        <h6 style="color: white;">Индивидуальная разработка</h6>
        <h6 style="color: white;">или бесплатный аккаунт</h6>
        ...
        <div style="display: none;">
          ...
          <div class="row">
            ...
            <div class="col col-md-12">
                <?= Html::submitButton('<i class="fa fa-eye"></i> Демонстрация (рекомендуется)', ['class' => 'btn btn-success btn-block btn-flat', 'id'=>'info', 'name' => 'login-button']) ?>
            </div>
