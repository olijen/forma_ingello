...
namespace forma\extensions\fullcalendar;

/**
 * Class CoreAsset
 * @package forma\extensions\fullcalendar
 */
class CoreAsset extends \yii\web\AssetBundle
{
    ...
    public $depends = [
        'yii\web\YiiAsset',
        'forma\extensions\fullcalendar\MomentAsset',
        'forma\extensions\fullcalendar\PrintAsset',
    ];
    /**
     * @var  boolean
