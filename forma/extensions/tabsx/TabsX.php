 ...
 * [bootstrap-tabsx plugin](http://plugins.krajee.com/tabs-x) by Krajee. This widget enhances the default bootstrap
...
class TabsX extends Widget
{
    ...
    public function initWidget()
    {
        ...
        Html::addCssClass($this->containerOptions, 'tabsx');
